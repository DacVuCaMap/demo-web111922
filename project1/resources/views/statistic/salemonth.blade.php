...
<main class="content">
<a href="{{ route('statistic.saleday') }}" class="badge bg-secondary">Revenue by day</a>
<a href="{{ route('statistic.salemonth') }}" style="margin: 0 10px" class="badge bg-success">Revenue by month</a>
<style>
.khung{
    margin: 10px;
    padding: 10px;
...
h3{
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-md-12">
                <fieldset >
                <span><strong style="color: rgb(255, 0, 140); font-size:16px">List Orders: @if($month_key != '1970-01'){{ $month_key }}@endif</strong></span>
                <table class="table table-success table-striped">
                    ...
                    <tbody>
                        @if(!empty($listordermonth))
                        @foreach ($listordermonth as $key=>$item)
                           <tr>
